...
#include "main_defs.F90"
  ...
  do while ( (iteration .le. max_it) .and. (.not. density_converged) )
     ...
     if (rank .eq. 0) then
        ...
        write(6,*) ' Iter   Mix     Converged Points       iter. time   Max eigenvalue'
        write(6,fmt=500,advance='NO')
#ifdef SECOND_ORDER
...
! Include these lines to supress off-diagonal terms
  ...
  if (rank .eq. 0) then
     ...
     close(unit=9)
        ...
        if (rank .eq. 0) then
           write(6,*) "  ", this_it_time - last_it_time, overall_eigenvalue_max
        endif
...
#ifdef THIRD_ORDER
        write(6,*) 'Max chi eigenvalue = ', overall_eigenvalue_max
        write(6,*) 'index(0) = ', dominant_chi_index(0)
        write(6,*) 'index(1) = ', dominant_chi_index(1)
        write(6,*) 'index(2) = ', dominant_chi_index(2)
        write(6,*) 'index(3) = ', dominant_chi_index(3)
        write(6,*) 'matrix_index_00 = ', dominant_chi_eigenvector(0)
        write(6,*) 'matrix_index_01 = ', dominant_chi_eigenvector(1)
        write(6,*) 'matrix_index_02 = ', dominant_chi_eigenvector(2)
        write(6,*) 'matrix_index_03 = ', dominant_chi_eigenvector(3)
        write(6,*) 'matrix_index_04 = ', dominant_chi_eigenvector(4)
        write(6,*) 'matrix_index_05 = ', dominant_chi_eigenvector(5)
        write(6,*) 'matrix_index_06 = ', dominant_chi_eigenvector(6)
        write(6,*) 'matrix_index_07 = ', dominant_chi_eigenvector(7)
        write(6,*) 'matrix_index_08 = ', dominant_chi_eigenvector(8)
        write(6,*) 'matrix_index_09 = ', dominant_chi_eigenvector(9)
        write(6,*) 'matrix_index_10 = ', dominant_chi_eigenvector(10)
        write(6,*) 'matrix_index_11 = ', dominant_chi_eigenvector(11)
        write(6,*) 'matrix_index_12 = ', dominant_chi_eigenvector(12)
        write(6,*) 'matrix_index_13 = ', dominant_chi_eigenvector(13)
        write(6,*) 'matrix_index_14 = ', dominant_chi_eigenvector(14)
        write(6,*) 'matrix_index_15 = ', dominant_chi_eigenvector(15)
#endif /* THIRD_ORDER */
