MODULE constants
	...
	! 计算范围取-(4nomega-1):4nomega, 共8nomega个 (待测试是否能够避开周期)
	! 费米频率循环 -(2*nomega-1),2*nomega-1,2, 玻色频率循环 -2(2nomega-1),2(2nomega-1),2
	...
	! k点
	integer, parameter :: nkx = 1
	integer, parameter :: nky = 1
